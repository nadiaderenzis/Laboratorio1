...
int main()
{
    ...
    //-----------------------------------------------------------------------------------------------------------------
     ...
     usuario[0].isEmpty=0;
     usuario[0].id=0;
     usuario[0].contadorPuntuaciones= 5;
     usuario[0].puntuacion=36;
    ...
    do
    {
        ...
        case 4:
            ...
            break;
        case 5:
            if(modificarPublicacion(usuario,CANT,producto,CANTPROD))
                printf("\nProducto modificado.\n");
        ...
        case 6:
            ...
            break;
        case 7:
            if(compraProducto(usuario,CANT,producto,CANTPROD))
            printf("\nProducto comprado.\n");

            break;
        case 8:
            listarPublicacionesDeUsuario(usuario,CANT,producto,CANTPROD);

            break;
        case 9:
            listarPublicaciones(usuario,CANT,producto,CANTPROD);
        ...
        case 10:
            ...
            for(i=0; i<CANT; i++)
            {
                ...
                {
                    if(usuario[i].contadorPuntuaciones>0)
                        usuario[i].promedio=usuario[i].puntuacion/usuario[i].contadorPuntuaciones;
                    printf("Nombre %s --Password %s -- ID: %d --Promedio Calificaciones: %.2f\n\n",usuario[i].nombre,usuario[i].password,usuario[i].id,usuario[i].promedio);
                }
            }
            break;
        default :
